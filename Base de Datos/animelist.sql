...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-02-2021 a las 13:58:11
...
--
-- Volcado de datos para la tabla `usu_ani`
--

INSERT INTO `usu_ani` (`usu_ani_id`, `id_usuario`, `id_anime`) VALUES
(1, 1, 3),
(2, 1, 2),
(3, 1, 1),
(4, 1, 4),
...
--
-- AUTO_INCREMENT de la tabla `usu_ani`
--
ALTER TABLE `usu_ani`
  MODIFY `usu_ani_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
